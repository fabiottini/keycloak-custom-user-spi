...
$client_id = $_ENV['CLIENT_ID2'] ?? 'test_client2';
$client_secret = $_ENV['CLIENT_SECRET2'] ?? 'qOkhxR5xc4wzlgANgWXYzjnynRRSKRhY';
$redirect_port = $_ENV['REDIRECT_PORT'] ?? '8082';
...
<head>
    ...
    <title>Apache 2 - SSO Test with Keycloak</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="navigation">
            ...
            <a href="http://<?= $keycloak_host ?>:<?= $redirect_port === '8082' ? '8083' : '8083' ?>" class="btn btn-success">
                🔗 Go to Server <?= $redirect_port === '8082' ? '1 (Port 8083)' : '1 (Port 8083)' ?>
            </a>
